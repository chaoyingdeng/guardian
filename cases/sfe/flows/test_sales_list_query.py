...
def start(instance):
    pre_period = instance.sfe_manage.get_pre_period().json().get('data').get('id')
    resp_1 = instance.sfe_manage.month_flow_query(pre_period, 1)
    ...
    resp_2 = instance.sfe_manage.month_flow_detail(flow_id)
